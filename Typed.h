...
#define TArrayDeclare(Element)  @protocol TArray_##Element;

TArrayDeclare(NSString)
TArrayDeclare(NSSortDescriptor)
...
TArrayGenerate(NSSortDescriptor) //!< Must be first, because it is used by the TArrayGenerate() itself.
